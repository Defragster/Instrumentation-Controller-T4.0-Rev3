...
This repo provides gerbers for the updated controller for the SPI instrumentation prohect.  This update allows you to control peripherals with both SPI and precisely time clock signals generated by the Teensy 4.0's FlexPWM module, and it also provides power management with current limiting for +5V power.  You need this specific controller for the latest version CCD sensor devices, and this will be the standard for the SPI instrumentation project going forward.

The following image of the layout shows the interconnects provided by the controller.
...
Please direct message or email with any questions.
